...
/* harmony import */ var _utils_observers_index__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../utils/observers/index */ "./src/js/utils/observers/index.js");
/* harmony import */ var _js_level_scale__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./js-level-scale */ "./src/js/index-page/js-level-scale.js");
/* harmony import */ var _js_level_counter__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./js-level-counter */ "./src/js/index-page/js-level-counter.js");
/* harmony import */ var _info_inputs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./info-inputs */ "./src/js/index-page/info-inputs.js");
/* harmony import */ var _info_stamp__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./info-stamp */ "./src/js/index-page/info-stamp.js");
/* harmony import */ var _skills__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./skills */ "./src/js/index-page/skills.js");
/* harmony import */ var _portfolio_sliders__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./portfolio-sliders */ "./src/js/index-page/portfolio-sliders.js");
...
/* harmony default export */ __webpack_exports__["default"] = (function ($window, resizeObserver, scrollRevealObserver) {
  ...
  var $inputInfoName = $('#infoName');
  var $inputInfoCity = $('#infoCity');
  var $inputInfoDob = $('#infoDob');
  var $inputInfoContacts = $('#infoContacts');
  var startAnimation = false;
  $inputInfoName.val('');
  $inputInfoCity.val('');
  $inputInfoContacts.val('');
  $inputInfoDob.val(''); // тут eslint выключаю что бы сохранить последовательность элементов так же как в верстке
...
/***/ "./src/js/index-page/portfolio-sliders.js":
/*!************************************************!*\
  !*** ./src/js/index-page/portfolio-sliders.js ***!
  \************************************************/
/*! exports provided: default */
...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  var fullScreenClassName = 'slider-wrap-full-screen';
  var $buttonResizeSlider = $('.button-resize-slider');
  var $portfolioItemSlider = $('.slider-slick-portfolio-item'); // const $sliderVKApp = $('.slider-vk-app');
  ...
  $portfolioItemSlider.slick(slickConfig); // $sliderVKApp.slick(slickConfig);
...
'html5', 'css3', 'БЭМ', 'SCSS', 'gulp', 'webpack', 'vanillaJS', 'react', 'redux', 'jquery', 'git', 'git-flow'];
...
/* harmony default export */ __webpack_exports__["default"] = (function ($window, resizeObserver, scrollRevealObserver) {
  ...
  checkboxes.forEach(function (checkboxId) {
    return $("#".concat(checkboxId)).prop('checked', false);
  });
